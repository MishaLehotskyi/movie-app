...
export const AddMoviePage = () => {
  const initialMovie: Omit<Movie, 'id'> = {
    title: '',
    description: '',
    rating: 0,
    release_date: '',
  ...
  const [movie, setMovie] = useState<Omit<Movie, 'id'>>(initialMovie);
  const {
    title,
    description,
    rating,
  ...
  const handleFormSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    if (canSubmit) {
      const data: Omit<Movie, 'id'> = movie;
  ...
  return (
    ...
    >
      ...
      <div className="mb-4">
        ...
        <input
          className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
          id="rating" type="number" name="rating" min="0" max="10" step="0.1" placeholder="Rating"
      ...
      <div className="mb-4">
        ...
        <input
          className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
          id="release_date" type="date" name="release_date" placeholder="Release Date"
      ...
      <div className="mb-4">
        ...
        <input
          className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
          id="image" type="text" name="image" placeholder="Image URL"
